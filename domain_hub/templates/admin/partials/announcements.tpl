  ...
  <div class="card-body">
    ...
    <form method="post" class="row g-3">
      ...
      <div class="col-12">
        ...
        <textarea class="form-control" id="admin_announce_html_input" name="admin_announce_html" rows="4" placeholder="<?php echo htmlspecialchars($contentLabel); ?>"><?php echo htmlspecialchars($admin_announce_html); ?></textarea>
      </div>
      <div class="col-12">
